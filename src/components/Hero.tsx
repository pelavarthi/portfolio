export default function Hero() {
  return (
    <section className="relative flex min-h-full flex-col items-center justify-center bg-[#f0f4f8] px-6 pb-16 pt-24 text-center text-stone-900">
      ...
      <p className="mt-4 text-xl text-stone-600 sm:text-2xl">
        Full-stack developer &amp; cybersecurity engineer
      </p>
      <p className="mt-8 max-w-2xl text-lg leading-relaxed text-stone-600">
        CS student at the University of Virginia with experience in
